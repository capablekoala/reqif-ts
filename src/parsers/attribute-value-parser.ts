...
export class AttributeValueParser {
  ...
  static parse(element: Element): ReqIFAttributeValue | null {
    ...
    if (!defRefElement || !defRefElement.textContent) {
      console.warn(`Attribute definition missing reference: ${defElement.outerHTML}`);
      return null;
    }
    ...
    switch (attributeType) {
      case 'STRING':
        return AttributeValueParser.parseStringAttributeValue(element, definitionRef);
      case 'INTEGER':
        return AttributeValueParser.parseIntegerAttributeValue(element, definitionRef);
      case 'REAL':
        return AttributeValueParser.parseRealAttributeValue(element, definitionRef);
      case 'BOOLEAN':
        return AttributeValueParser.parseBooleanAttributeValue(element, definitionRef);
      case 'DATE':
        return AttributeValueParser.parseDateAttributeValue(element, definitionRef);
      case 'ENUMERATION':
        return AttributeValueParser.parseEnumerationAttributeValue(element, definitionRef);
      case 'XHTML':
        return AttributeValueParser.parseXhtmlAttributeValue(element, definitionRef);
      default:
   ...
   */
  static parseAttributeValues(valuesElements: Element[]): ReqIFAttributeValue[] {
   ...
   */
  private static parseStringAttributeValue(element: Element, definitionRef: string): ReqIFAttributeValueString {
   ...
   */
  private static parseIntegerAttributeValue(element: Element, definitionRef: string): ReqIFAttributeValueInteger {
    const valueElement = element.querySelector('THE-VALUE');
   ...
   */
  private static parseRealAttributeValue(element: Element, definitionRef: string): ReqIFAttributeValueReal {
    const valueElement = element.querySelector('THE-VALUE');
    let value: number | null = null;
   ...
   */
  private static parseBooleanAttributeValue(element: Element, definitionRef: string): ReqIFAttributeValueBoolean {
    const valueElement = element.querySelector('THE-VALUE');
   ...
   */
  private static parseDateAttributeValue(element: Element, definitionRef: string): ReqIFAttributeValueDate {
    const valueElement = element.querySelector('THE-VALUE');
    const value = valueElement ? valueElement.textContent : null;
   ...
   */
  private static parseEnumerationAttributeValue(element: Element, definitionRef: string): ReqIFAttributeValueEnumeration {
   ...
   */
  private static parseXhtmlAttributeValue(element: Element, definitionRef: string): ReqIFAttributeValueXHTML {
    const valueElement = element.querySelector('THE-VALUE');
    ...
    const strippedContent = originalContent ? stripXhtmlNamespaces(originalContent) : null;
    
    return new ReqIFAttributeValueXHTML(definitionRef, strippedContent, originalContent);
  }
   ...
   */
  static unparseAttributeValues(attributeValues: ReqIFAttributeValue[]): string {
    ...
    for (const attrValue of attributeValues) {
      switch (attrValue.kind) {
        case 'STRING':
          result += AttributeValueParser.unparseStringAttributeValue(attrValue as ReqIFAttributeValueString);
          break;
        case 'INTEGER':
          result += AttributeValueParser.unparseIntegerAttributeValue(attrValue as ReqIFAttributeValueInteger);
          break;
        case 'REAL':
          result += AttributeValueParser.unparseRealAttributeValue(attrValue as ReqIFAttributeValueReal);
          break;
        case 'BOOLEAN':
          result += AttributeValueParser.unparseBooleanAttributeValue(attrValue as ReqIFAttributeValueBoolean);
          break;
        case 'DATE':
          result += AttributeValueParser.unparseDateAttributeValue(attrValue as ReqIFAttributeValueDate);
          break;
        case 'ENUMERATION':
          result += AttributeValueParser.unparseEnumerationAttributeValue(attrValue as ReqIFAttributeValueEnumeration);
          break;
        case 'XHTML':
          result += AttributeValueParser.unparseXhtmlAttributeValue(attrValue as ReqIFAttributeValueXHTML);
          break;
      }
    }
   ...
   */
  private static unparseStringAttributeValue(attrValue: ReqIFAttributeValueString): string {
   ...
   */
  private static unparseIntegerAttributeValue(attrValue: ReqIFAttributeValueInteger): string {
   ...
   */
  private static unparseRealAttributeValue(attrValue: ReqIFAttributeValueReal): string {
   ...
   */
  private static unparseBooleanAttributeValue(attrValue: ReqIFAttributeValueBoolean): string {
   ...
   */
  private static unparseDateAttributeValue(attrValue: ReqIFAttributeValueDate): string {
   ...
   */
  private static unparseEnumerationAttributeValue(attrValue: ReqIFAttributeValueEnumeration): string {
    let enumValuesXml = '';
   ...
   */
  private static unparseXhtmlAttributeValue(attrValue: ReqIFAttributeValueXHTML): string {
